...
local data = {
	...
	{col = 1, itemId = 44469, itemName = "Enchant Boots - Assault", type = "Boots"},
	...
	{col = 1, itemId = 38975, itemName = "Enchant Chest - Exceptional Resilience", type = "Chest"},
	...
	{col = 2, itemId = 30846, itemName = "Arcanum of the Outcast", type = "Head"},
	{col = 2, itemId = 44069, itemName = "Arcanum of Triumph", type = "Head"},
	{col = 2, itemId = 44075, itemName = "Arcanum of Dominance", type = "Head"},
    {col = 2, itemId = 44149, itemName = "Arcanum of Torment", type = "Head"},
	{col = 2, itemId = 44133, itemName = "Greater Inscription of the Axe", type = "Shoulder"},
    {col = 2, itemId = 44957, itemName = "Greater Inscription of the Gladiator", type = "Shoulder"},
    {col = 2, itemId = 44136, itemName = "Greater Inscription of the Pinnacle", type = "Shoulder"},
    {col = 2, itemId = 44135, itemName = "Greater Inscription of the Storm", type = "Shoulder"},
	{col = 2, itemId = 44067, itemName = "Inscription of Triumph", type = "Shoulder"},
	{col = 2, itemId = 44068, itemName = "Inscription of Dominance", type = "Shoulder"},
    {col = 3, itemId = 41602, itemName = "Brilliant Spellthread", type = "Legs"},
    {col = 3, itemId = 41604, itemName = "Sapphire Spellthread", type = "Legs"},
    {col = 3, itemId = 38373, itemName = "Frosthide Leg Armor", type = "Legs"},
    {col = 3, itemId = 38374, itemName = "Icescale Leg Armor", type = "Legs"},
    {col = 3, itemId = 38945, itemName = "Enchant Shield - Major Stamina", type = "Shield"},
    {col = 3, itemId = 44455, itemName = "Enchant Shield - Greater Intellect", type = "Shield"},
